...
from service.schedule.schedule_processing import (
    process_data_to_text_for_teachers,
    process_data_to_text_for_cabinets,
    process_data_to_text_for_groups
)
import logging
...
async def get_schedule(id, target_date, schedule_type="teachers"):
    try:
        ...
        if schedule_type == "teachers":
            ...
            result = process_data_to_text_for_groups(data, target_date)
        return result
